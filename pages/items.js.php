...
<script type="text/javascript">
    ...
    */
                        ...
                        */
                        ...
                        clipboardForPassword.on('success', function(e) {
                            ...
                            */
                            ...
                            toastr
                                .warning(
                                    "Clipboard will be cleared in a couple of seconds",
                                    '', {
                                        timeOut: 5000,
                                        progressBar: true
                                    }
                                );
                            console.log('je lance la suppression')
                            clearClipboardTimeout(10, "done");
     ...
     * 
     */
    function clearClipboardTimeout(duration, message) {
        console.log('suppression activée 1')
        $(this).delay(duration * 1000).queue(function() {
            console.log('suppression activée 2')

            navigator.clipboard.writeText(" ").then(function() {
                // clipboard successfully set
                alertify.set('notifier', 'position', 'top-right');
                alertify
                    .message('Clipboard cleared', 2)
                    .dismissOthers();
            }, function() {
